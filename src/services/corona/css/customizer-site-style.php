<style id="color-scheme" color-scheme="u15" color-style="multicolor-5">.u-body {
--none: transparent;
...
--custom-color-1: #5ca9ef;
--custom-color-1-darker: #3e99ec;
--custom-color-1-r: 92;
--custom-color-1-g: 169;
--custom-color-1-b: 239;
--custom-color-1-contrast: white;
--custom-color-1-contrast-darker: white;
--custom-color-1-text-color: var(--body-alt-color);
--custom-color-2: #2c798e;
--custom-color-2-darker: #286d80;
--custom-color-2-r: 44;
--custom-color-2-g: 121;
--custom-color-2-b: 142;
...
--custom-color-3-darker: #c1c1c1;
--custom-color-3-r: 214;
--custom-color-3-g: 214;
--custom-color-3-b: 214;
--custom-color-3-contrast: black;
--custom-color-3-contrast-darker: black;
--custom-color-3-text-color: var(--body-color);
--custom-color-4: #a3a3a3;
--custom-color-4-darker: #939393;
--custom-color-4-r: 163;
--custom-color-4-g: 163;
--custom-color-4-b: 163;
--custom-color-4-contrast: white;
--custom-color-4-contrast-darker: white;
--custom-color-4-text-color: var(--body-alt-color);
--custom-color-5: rgba(var(--custom-color-5-r),var(--custom-color-5-g),var(--custom-color-5-b),0.81);
--custom-color-5-darker: rgba(0,29,55,0.81);
--custom-color-5-r: 0;
--custom-color-5-g: 32;
--custom-color-5-b: 61;
