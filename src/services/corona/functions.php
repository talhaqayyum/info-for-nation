    ...
    function outputErrorPage($context) {
        ...
        <div id="errorboxbody">
            ...
            <?php if ($format === 'html' && JModuleHelper::getModule('mod_search')) : ?>
                <div id="searchbox">
                    <h3 class="unseen">
                        <?php echo JText::_('TPL_PAGE404_SEARCH'); ?>
                    </h3>
                    <p>
            ...
            <div><!-- start goto home page -->
                <p>
                    <a href="<?php echo $context->baseurl; ?>/index.php" title="<?php echo JText::_('JERROR_LAYOUT_GO_TO_THE_HOME_PAGE'); ?>"><?php echo JText::_('JERROR_LAYOUT_HOME_PAGE'); ?></a>
                </p>
