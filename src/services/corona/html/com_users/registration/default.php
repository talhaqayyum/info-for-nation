...
<section class="u-clearfix">
    <div class="u-clearfix u-sheet">
        <div class="registration<?php echo $this->pageclass_sfx; ?>">
            ...
            <?php endif; ?>
            <div class="u-form">
                <form id="member-registration" action="<?php echo JRoute::_('index.php?option=com_users&task=registration.register'); ?>" method="post" class="<?php echo $formClass ? $formClass : 'form-validate form-horizontal well'; ?>" enctype="multipart/form-data">
                    <?php
